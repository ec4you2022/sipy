"""
Django settings for sipy project.
...
SECRET_KEY = 'django-insecure-=4lxt==%=af#niz+6ew5=37z5jo14$xw#0uui=06@b5ns+y2sg'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['sipy.in', 'www.sipy.in', 'localhost', '127.0.0.1']
...
WSGI_APPLICATION = 'sipy.wsgi.application'
...
EMIL_HOST_USER_NANE='SIPY'
ADMIN_EMAIL = 'aravintharavinth7746@gmail.com'
